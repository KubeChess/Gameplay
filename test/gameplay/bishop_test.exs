defmodule ClusterChess.Gameplay.Bishops.Test do
    ...
    test "bishop move ok [//, a1 -> d4, no capture]" do
        ...
        assert Validation.validate_move(state, {:a, 1}, {:d, 4})
    end
    ...
    test "bishop move ok [//, a1 -> d4, with suicide]" do
        ...
        state = %{board: board, castling_rights: %{}}
        assert not Validation.validate_move(state, {:a, 1}, {:d, 4})
    end
    ...
    test "bishop move ok [\\, a1 <- d4, no capture]" do
        ...
        state = %{board: board, castling_rights: %{}}
        assert Validation.validate_move(state, {:d, 4}, {:a, 1})
    end
    ...
    test "bishop move ok [\\, a1 <- d4, with suicide]" do
        ...
        state = %{board: board, castling_rights: %{}}
        assert not Validation.validate_move(state, {:d, 4}, {:a, 1})
    end
